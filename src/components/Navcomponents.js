...
import  pro  from './images/project.jpeg';
                        ...
                        <div className="col-lg-10" id="back">
                            ...
                            <div className="text-center text-light" id="back-text">
                                ...
                                <p style={{ padding: "20px 0" }}>
                                    Hi, I'm Sai Prasad, a passionate web developer. I create responsive and user-friendly websites and web applications. Explore my portfolio to see some of my recent projects.
                                </p>
                ...
                <div className="container mt-5 pt-5">
                    <div className="row justify-content-center">
                        <div className="col-lg-8 text-left mb-5">
                            ...
                            <p>
                                Hi there! I'm Sai Prasad, a passionate and creative web developer based in Chennai. With a strong background in web development and design, I create user-friendly and visually appealing websites. My expertise includes front-end and back-end technologies, allowing me to bring ideas to life from concept to implementation.
                            </p>
                            <p>
